...
**I probably am missing important details here/slightly speaking out of my arse HC**
...
The former should indicate whether rare molecules result in greater magnitudes of difference between technical replicates, and whether a high amplification efficiency amplifies this effect. To this end, we use coefficient of variation. The latter metric -- presence-absence disagreement -- relates to the frequency of dropouts among a set of technical replicates, which we propose increases with low DNA concentration and low amplification efficiency (**again: revisit this HC**). We represent this using the proportion of species (sample-specific) which had 1 to 3 dropouts among technical replicates.    
...
Figure 4 shows that the the average number of dropouts within a set of technical replicates declines as template DNA amount increases, consistent with our original hypothesis. At low and medium amplification efficiencies, rare species drop out at higher rates than counterparts with higher amplification efficiency. 
...
Figure 5 shows that the most dropouts within a set of technical replicates are seen for low count (0 - 10 larvae) species with medium amplification efficiency (-0.07 - 0).  Figure 6 differs from Figure 5 in that it includes species for which larvae were observed, though no sequenced reads are present (3 dropouts), representing rare species who are likely to have high dropout rates. Unsurprisingly, we see the most dropouts for species with low counts and amplification efficiencies.  
