...
Using CalCOFI's mock community -- including larval counts, amplification efficiency, and sequenced reads within technical replicates -- we tested whether a species' position in our hypothesized matrix explained variability in that species' read abundance among technical replicates.
