...
Below, we use multiple sources (**this is the goal, no?**) of empirical data to test our proposed mechanism of observation variance among technical replicates, with the ultimate goal of deciding when we can, and cannot, trust metabarcoding data.    
