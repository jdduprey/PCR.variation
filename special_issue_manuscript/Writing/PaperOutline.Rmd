...
.**I probably am missing important details here/slightly speaking out of my ass HC**

Using CalCOFI's mock community -- including larval counts, amplification efficiency, and sequenced reads within technical replicates -- we tested whether a species' position in our  our hypothesized matrix explained variability in that species' read abundance among technical.   
GO INTO WHAT WE DID (dropouts etc)

 ---- Below = moncho's data (taxa vs. dropouts), maybe we put a pin in that for now. ----
