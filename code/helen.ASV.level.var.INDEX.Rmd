...
## Description: 
  ...
  2) Then, I'll loop through different eDNA cutoffs (averaging index values across PCR reps for each hash), each time calculating the LOGNORMAL mean of all of the standard deviations (across bio reps, etc.)
