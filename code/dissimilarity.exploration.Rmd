...
"Permutational multivariate analysis of variance (PERMANOVA) is a non-parametric multivariate statistical test. It is used to compare groups of objects and test the null hypothesis that the centroids and dispersion of the groups as defined by measure space are equivalent for all groups." So we want to see how the DISSIMILARITY between samples in PCR Rep 1&2 compares to the DISSIMILARITY between samples in PCR Rep 1&3, etc. 
