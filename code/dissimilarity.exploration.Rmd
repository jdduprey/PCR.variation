...
par(mfrow = c(1, 3))
hist(beta.output[,1], main="PCRs 1 & 2", xlab="BDiv")
hist(beta.output[,2], main="PCRs 2 & 3", xlab="BDiv")
hist(beta.output[,3], main="PCRs 1 & 3", xlab="BDiv")
```
...
par(mfrow = c(1, 3))
hist(jac.output[,1], main="PCRs 1 & 2", xlab="Jaccard")
hist(jac.output[,2], main="PCRs 2 & 3", xlab="Jaccard")
hist(jac.output[,3], main="PCRs 1 & 3", xlab="Jaccard")
```
