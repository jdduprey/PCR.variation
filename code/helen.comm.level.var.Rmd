...
Extra code calculating same thing as above (distance to centroids), just no exclusions and over bioPCR sets (within sampling event), not just PCR sets. 

```{r}
testfunction <- function(list, SampleVector){
