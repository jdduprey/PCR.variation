...
hist(SD.bio.tech.output, breaks=20)
```
...
hist(SD.tech.output$StanDev, breaks=20)
hist(SD.bio.output$StanDev, breaks=20)

hist(log(SD.tech.output$StanDev), breaks=20)
hist(log(SD.bio.output$StanDev), breaks=20)
